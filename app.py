...
from utils import hash_password, verify_password, generate_token, create_jwt_payload
...
def login():
    ...
    print(f"Password verification result: {user.verify_password(password)}")

    if not user.verify_password(password):
        print(f"Login failed for user: {username}. Invalid password: {password}")
...
def register():
    ...
    print(f"Registering user: {username} with hashed password: {user.password}")
